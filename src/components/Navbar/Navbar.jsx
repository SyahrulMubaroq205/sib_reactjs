  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <Link to="/" className="hover:text-purple-600" onClick={() => setIsOpen(false)}>
            Home
          </Link>
          <Link to="/books" className="hover:text-purple-600">
            Books
          </Link>
          <Link to="/team" className="hover:text-purple-600" onClick={() => setIsOpen(false)}>
            Team
          </Link>
          <Link to="/contact" className="hover:text-purple-600" onClick={() => setIsOpen(false)}>
            Contact
          </Link>
