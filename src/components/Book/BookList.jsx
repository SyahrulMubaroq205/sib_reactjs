            ...
            {books.map((book) => (
                ...
                >
                    ...
                    <div className="p-5 flex flex-col flex-1">
                        ...
                        {/* Button Buy */}
                        <button
                            className="mt-auto py-3 rounded-2xl font-semibold text-white bg-yellow-400 hover:bg-yellow-500 transition-all duration-200 flex justify-center items-center gap-2 shadow-md hover:scale-105 hover:shadow-lg"
                        >
                            <FaShoppingCart /> Buy
                        </button>
                    </div>
